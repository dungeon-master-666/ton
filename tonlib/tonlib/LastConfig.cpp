...
void LastConfig::with_last_block(td::Result<LastBlockState> r_last_block) {
  ...
  client_.send_query(ton::lite_api::liteServer_getConfigAll(block::ConfigInfo::needPrevBlocks,
                     ...
                     [this, requested_block_id](auto r_config) {
                       this->on_config(requested_block_id, std::move(r_config));
                     });
}
...
td::Status LastConfig::process_config(const ton::BlockIdExt& requested_block_id,
                                      td::Result<ton::ton_api::object_ptr<ton::lite_api::liteServer_configInfo>>
                                          r_config) {
...
td::Status LastConfig::process_config_proof(
  ...
  TRY_RESULT(config,
             block::ConfigInfo::extract_config(std::move(state), requested_block_id,
